...
from typing import Any, Callable, Dict, Union, Optional, List, TypeVar, Protocol, runtime_checkable
...
def pmap_func(operator_or_fn: Any, num_workers: Optional[int] = None, devices: Optional[List[str]] = None) -> Callable:
...
def pjit_func(operator_or_fn: Any, num_workers: Optional[int] = None, devices: Optional[List[str]] = None, 
              static_argnums: Optional[List[int]] = None) -> Callable:
...
def mesh_sharded_func(operator_or_fn: Any, mesh: Any, partition_spec: Optional[Dict[str, Any]] = None) -> Callable:
...
try:
    ...
    from .mesh import DeviceMesh as _DeviceMesh, PartitionSpec as _PartitionSpec, mesh_sharded as _mesh_sharded
