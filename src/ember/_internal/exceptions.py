"""Domain-specific exception hierarchy with structured context and recovery hints."""
...
class EmberError(Exception):
    ...
    def add_context(self, **kwargs: Any) -> "EmberError":
        ...
        Returns:
            EmberError: The exception instance for fluent chaining.
        """
    ...
    def get_context(self) -> Dict[str, Any]:
        ...
        Returns:
            Dict[str, Any]: Copy of the contextual metadata.
        """
    ...
    def _format_message(self) -> str:
        ...
        Returns:
            str: Formatted message suitable for logging and display.
        """
        parts = []
    ...
    def from_exception(
        ...
        Args:
            ...
            message: Optional message (defaults to the exception message).
            **context: Additional context to include.

        Returns:
            EmberError: Wrapped exception instance with context applied.
        """
        if message is None:
    ...
    def with_context(cls, message: str, **context: Any) -> "EmberError":
        ...
        Returns:
            EmberError: Exception instance with context populated.
        """
...
class ItemNotFoundError(RegistryError):
    ...
    def for_item(cls, item_name: str, registry_name: Optional[str] = None) -> "ItemNotFoundError":
        ...
        Returns:
            ItemNotFoundError: Exception describing the missing item.
        """
...
class ModelProviderError(ModelError):
    ...
    def for_provider(
        ...
        Returns:
            ModelProviderError: Exception tailored to the provider failure.
        """
...
class ModelNotFoundError(ModelError):
    ...
    def for_model(
        ...
        Returns:
            ModelNotFoundError: Exception describing the missing model.
        """
...
class ProviderAPIError(ModelError):
    ...
    def for_provider(
        ...
        Returns:
            ProviderAPIError: Exception carrying provider and status metadata.
        """
...
class ModelDiscoveryError(ModelError):
    ...
    def for_provider(
        ...
        Returns:
            ModelDiscoveryError: Exception explaining the discovery failure.
        """
...
class ModelRegistrationError(ModelError):
    ...
    def for_model(
        ...
        Returns:
            ModelRegistrationError: Exception describing the registration issue.
        """
