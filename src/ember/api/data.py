...
def datasets(name: str, config: Optional[Union[Dict[str, Any], DatasetConfig]] = None) -> Dataset[DatasetEntry]:
    ...
    if dataset_entry is None:
        raise ValueError(f"Dataset '{name}' not found. Available datasets: {UNIFIED_REGISTRY.list_datasets()}")
