...
class MockLMModule:
    ...
    def __init__(self, response_style: str = "normal", response_quality: str = "good"):
        ...
        self.style_phrases = {
            ...
            "detailed": ["In a comprehensive analysis", "Considering all factors", "In detail"],
...
class SimpleEnsembleOperator(Operator[EnsembleInput, EnsembleOutput]):
    ...
    def __init__(self, num_units: int = 3) -> None:
        ...
        for i in range(num_units):
            ...
            self.lm_modules.append(MockLMModule(response_style=style, response_quality=quality))
