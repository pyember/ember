...
###############################################################################
def build_multi_branch_pipeline(*, query: str, max_workers: Optional[int] = None) -> Dict[str, Any]:
    ...
    creative_id = graph.add_node(operator=creative_ensemble, node_id="creative_ensemble")
    detailed_id = graph.add_node(operator=detailed_ensemble, node_id="detailed_ensemble")
    ...
    workers = max_workers or 12  # Default to 12 workers (3 ensembles × 3 units + overhead)
