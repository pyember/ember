...
def main():
    ...
    registry = initialize_ember(auto_discover=False, auto_register=False)
    ...
    try:
        ...
        openai_response = model_service("openai:gpt-4o", "What is the capital of France?")
    ...
    try:
        ...
        anthropic_response = model_service("anthropic:claude-3-opus", "What is the capital of Italy?")
