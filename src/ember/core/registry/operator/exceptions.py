...
class OperatorExecutionError(EmberException):
    ...
    def __init__(self, message: str = "An error occurred during operator execution.") -> None:
...
class BoundMethodNotInitializedError(EmberException):
    ...
    def __init__(self, message: str = "BoundMethod not properly initialized with __func__ and __self__."):
        super().__init__(message)
