...
class ModelService:
    ...
    def invoke_model(self, model_id: str, prompt: str, **kwargs: Any) -> ChatResponse:
        """Invokes a model synchronously using the specified identifier, prompt, and additional parameters.
    ...
    async def invoke_model_async(
        ...
        try:
            ...
            raise ProviderAPIError(f"Async error invoking model {model_id}") from exc
