...
try:
    ...
    from src.ember.core.registry.model.base.registry import model_registry, discovery, factory
    sys.modules["ember.core.registry.model.base.registry.model_registry"] = model_registry
    ...
    from src.ember.core.utils.data import registry, metadata_registry, initialization, loader_factory
    ...
    sys.modules["ember.core.utils.data.datasets_registry.commonsense_qa"] = commonsense_qa
