...
from ember.core.registry.model.providers.deepmind.deepmind_discovery import DeepmindDiscovery


@pytest.mark.integration
@pytest.mark.skipif(not os.environ.get("RUN_PROVIDER_INTEGRATION_TESTS"), 
...
class TestProviderDiscoveryIntegration:
    ...
    def test_openai_discovery_integration(self):
        ...
        assert any("gpt-" in model_id for model_id in models.keys()), "No GPT models found"
    ...
    def test_anthropic_discovery_integration(self):
        ...
        assert any("claude" in model_id for model_id in models.keys()), "No Claude models found"
    ...
    def test_deepmind_discovery_integration(self):
        ...
        assert any("gemini" in model_id for model_id in models.keys()), "No Gemini models found"
