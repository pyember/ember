...
should_run_integration = os.environ.get("RUN_INTEGRATION_TESTS", "").lower() in ("1", "true", "yes")
skip_integration_reason = "Integration tests require RUN_INTEGRATION_TESTS=1 environment variable"
...
class TestRealDataIntegration(unittest.TestCase):
    ...
    should_run_real_api = (
        ...
        and os.environ.get("ALLOW_EXTERNAL_API_CALLS", "").lower() in ("1", "true", "yes")
    )
