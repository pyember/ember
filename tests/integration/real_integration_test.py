...
Summary:""",
    ...
    def __init__(self, *, model_id: str = "openai:gpt-3.5-turbo", simulate_api: bool = True):
        """Initialize with a language model.
        
        Sets up the immutable fields. All fields are frozen after initialization.
        """
        self.lm_module = LMModule(
            config=LMModuleConfig(id=model_id),
        ...
        self._init_field(field_name="stats", value={
            "calls": 0,
            "total_tokens": 0,
...
class SequentialPipeline:
    ...
    def __init__(self, operators: List[Operator], input_mappings: Optional[List[Dict[str, Callable]]] = None):
        """
...
class TestRealIntegration:
    ...
    def test_lm_module_simulated_call(self):
        ...
        assert "SIMULATED_RESPONSE" in result, f"Expected simulated response, got: {result}"
    ...
    def test_parallel_lm_calls(self):
        ...
        for i, response in enumerate(responses):
            ...
            assert "SIMULATED_RESPONSE" in response, f"Module {i} did not return simulated response"
    ...
    def test_config_variations(self):
        ...
        modules = [
            LMModule(config=config, simulate_api=True)
    ...
    def test_sequential_pipeline(self):
        ...
        pipeline = SequentialPipeline(
            operators=[summarizer, translator],
