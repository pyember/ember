...
class TestUnifiedDatasetRegistry(unittest.TestCase):
    ...
    def test_register_metadata(self) -> None:
        ...
        assert dataset is not None
        self.assertEqual(self.dataset_info.name, dataset.name)
        self.assertEqual(self.dataset_info.description, dataset.info.description if dataset.info else None)
...
class TestRegisterDecorator(unittest.TestCase):
    ...
    def test_register_decorator(self) -> None:
        ...
        with mock.patch('ember.core.utils.data.registry.UNIFIED_REGISTRY.register_with_decorator') as mock_register:
...
class TestCompatibilityLayer(unittest.TestCase):
    ...
    def test_legacy_imports_point_to_unified_registry(self) -> None:
        ...
        # Verify that all legacy classes point to UNIFIED_REGISTRY
        self.assertIs(self.DatasetRegistry, UNIFIED_REGISTRY)
        self.assertIs(self.DatasetRegistryManager, UNIFIED_REGISTRY)
        self.assertIs(self.DatasetMetadataRegistry, UNIFIED_REGISTRY)
