...
from src.ember.core.utils.data.datasets_registry.halueval import HaluEvalPrepper, HaluEvalConfig
...
class TestHaluEvalPrepper(unittest.TestCase):
    ...
    def test_get_required_keys(self) -> None:
        ...
        # Assert
        self.assertEqual(["knowledge", "question", "right_answer", "hallucinated_answer"], required_keys)
    ...
    def test_create_dataset_entries(self) -> None:
        ...
        self.assertEqual({"A": "Not Hallucinated", "B": "Hallucinated"}, not_hallucinated_entry.choices)
        ...
        self.assertEqual({"A": "Not Hallucinated", "B": "Hallucinated"}, hallucinated_entry.choices)
