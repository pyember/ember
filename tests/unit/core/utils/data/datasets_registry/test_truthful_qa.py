...
class TestTruthfulQAPrepper(unittest.TestCase):
    ...
    def test_create_dataset_entries(self) -> None:
        ...
        # Check metadata
        self.assertEqual("B", entry.metadata["correct_answer"])  # Should be B for Paris (index 1)
    ...
    def test_create_dataset_entries_no_correct_answer(self) -> None:
        ...
        # Arrange & Act
        entries = self.prepper.create_dataset_entries(item=self.test_item_no_correct_answer)
