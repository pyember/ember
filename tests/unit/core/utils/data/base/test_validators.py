...
from src.ember.core.utils.data.base.validators import IDatasetValidator, DatasetValidator
...
class TestIDatasetValidator(unittest.TestCase):
    ...
    def test_interface_enforcement(self) -> None:
        ...
        class PartialValidator2(IDatasetValidator):
            ...
            def validate_required_keys(self, *, item: Dict[str, Any], required_keys: List[str]) -> None:
                pass
...
class TestDatasetValidator(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.mock_dataset_dict.__contains__.side_effect = lambda key: key in ["train", "validation", "test"]
        self.mock_dataset_dict.__iter__.return_value = iter(["train", "validation", "test"])
    ...
    def test_validate_structure_dataset_dict_fallback(self) -> None:
        ...
        mock_dataset_dict.__contains__.side_effect = lambda key: key in ["train", "test"]
