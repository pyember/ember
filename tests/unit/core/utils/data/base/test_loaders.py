...
from src.ember.core.utils.data.base.loaders import IDatasetLoader, HuggingFaceDatasetLoader
...
class TestHuggingFaceDatasetLoader(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.load_dataset_patcher = mock.patch("src.ember.core.utils.data.base.loaders.load_dataset")
    ...
    def test_init_default_cache_dir(self) -> None:
        ...
        # Assert
        expected_cache_dir = os.path.join("/mocked/home", ".cache", "huggingface", "datasets")
