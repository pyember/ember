...
from src.ember.core.utils.data.base.loaders import IDatasetLoader
from src.ember.core.utils.data.base.validators import IDatasetValidator
from src.ember.core.utils.data.base.samplers import IDatasetSampler
from src.ember.core.utils.data.base.transformers import IDatasetTransformer
...
class TestDatasetService(unittest.TestCase):
    ...
    def test_init(self) -> None:
        ...
        self.assertEqual(
            [self.mock_transformer1, self.mock_transformer2],
            service._transformers
        )
    ...
    def test_validate_keys(self) -> None:
        ...
        # Arrange
        self.raw_dataset.__len__ = mock.MagicMock(return_value=len(self.mock_dataset_items))
        ...
        self.assertGreaterEqual(self.mock_validator.validate_required_keys.call_count, 1)
    ...
    def test_sample_data(self) -> None:
        ...
        # Act
        result = self.service._sample_data(data=self.raw_dataset, num_samples=num_samples)
    ...
    def test_prep_data(self) -> None:
        ...
        self.assertEqual(
            len(self.mock_dataset_items),
            self.mock_validator.validate_item.call_count
        )
    ...
    def test_prep_data_error_handling(self) -> None:
        ...
        def validate_item_side_effect(*, item: Dict[str, Any], required_keys: List[str]) -> None:
            if item["id"] == 1:
    ...
    def test_load_and_prepare_end_to_end(self) -> None:
        ...
        def select_split_side_effect(dataset: Any, config_obj: Optional[BaseDatasetConfig]) -> Any:
        ...
        mock_entries = [
            DatasetEntry(query="Q1"),
            DatasetEntry(query="Q2")
        ]
