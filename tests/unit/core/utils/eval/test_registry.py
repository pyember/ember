...
class TestEvaluatorRegistry(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.mock_factory1 = mock.MagicMock(return_value=mock.MagicMock(spec=IEvaluator))
        self.mock_factory2 = mock.MagicMock(return_value=mock.MagicMock(spec=IEvaluator))
    ...
    def test_real_factory_functions(self) -> None:
        ...
        def create_parametrized_evaluator(threshold: float = 0.5) -> IEvaluator[float, float]:
