...
class TestFieldFunctions(unittest.TestCase):
    ...
    def test_static_field_metadata(self) -> None:
        ...
        self.assertEqual(
            first=field_obj.metadata.get("static"),
            second=True,
            msg="Expected static metadata to be True",
        )
        self.assertEqual(
            first=field_obj.default, second=10, msg="Expected default value to be 10"
        )
    ...
    def test_ember_field_with_converter(self) -> None:
        ...
        self.assertEqual(
            first=field_obj.metadata.get("converter"),
            second=converter_fn,
    ...
    def test_ember_field_without_converter(self) -> None:
        ...
        self.assertIsNone(
            field_obj.metadata.get("converter"),
            msg="Expected converter metadata to be None",
        )
        self.assertIsNone(
            field_obj.metadata.get("static"), msg="Expected static metadata to be None"
        )
        self.assertEqual(
            first=field_obj.default, second=5, msg="Expected default value to be 5"
        )
    ...
    def test_ember_field_converter_application(self) -> None:
        ...
        self.assertEqual(
            instance.x, 42, "Converter should convert string '42' to int 42"
        )
...
class TestFlattenAndUnflatten(unittest.TestCase):
    ...
    def test_flatten_ember_module(self) -> None:
        ...
        self.assertEqual(
            first=dynamic, second=[10], msg="Expected dynamic fields to contain [10]"
        )
        self.assertEqual(
            first=static,
            second={"b": 20},
    ...
    def test_unflatten_ember_module(self) -> None:
        ...
        self.assertEqual(
            first=_flatten_ember_module(self.instance),
    ...
    def test_unflatten_error_on_mismatch(self) -> None:
        ...
        with self.assertRaises(
            ValueError, msg="Expected ValueError for mismatched dynamic field count"
        ):
    ...
    def test_nested_module_flatten_unflatten(self) -> None:
        ...
        reconstructed = _unflatten_ember_module(
            cls=OuterModule, aux=static, children=dynamic
        )
        self.assertEqual(
            first=outer_instance,
...
class TestEmberModule(unittest.TestCase):
    ...
    def test_mutable_initialization_phase(self) -> None:
        ...
        self.assertEqual(
            first=instance.b, second=10, msg="Field 'b' should be twice field 'a'"
        )
        with self.assertRaises(
            FrozenInstanceError,
    ...
    def test_repr(self) -> None:
        ...
        self.assertIn(
            member=self.ComputedModule.__name__ + "(",
