...
def test_usage_stats_addition() -> None:
    ...
    usage2 = UsageStats(total_tokens=150, prompt_tokens=90, completion_tokens=60, cost_usd=0.2)
...
def test_usage_stats_add_method() -> None:
    ...
    usage1 = UsageStats(total_tokens=80, prompt_tokens=50, completion_tokens=30, cost_usd=0.05)
    usage2 = UsageStats(total_tokens=20, prompt_tokens=10, completion_tokens=10, cost_usd=0.02)
