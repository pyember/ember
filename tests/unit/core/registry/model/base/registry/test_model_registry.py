...
from ember.core.registry.model.base.utils.model_registry_exceptions import ProviderConfigError
...
def test_concurrent_registration():
    ...
    ModelFactory.create_model_from_info = staticmethod(lambda *, model_info: MockProvider(model_info=model_info))
