...
from typing import Dict, Any, List, Optional, TypeVar, Generic, Callable, Protocol, runtime_checkable, Type, Union
...
class LMModuleConfig:
    ...
    def __init__(self, model_name: str, temperature: float = 1.0, max_tokens: Optional[int] = None):
        self.model_name = model_name
        self.temperature = temperature
...
__all__ = [
    "Operator", "EmberModule", "T_in", "T_out", "Specification",
    "UniformEnsemble", "MostCommon", "JudgeSynthesis", "Verifier", "Sequential",
    "EnsembleInputs", "EnsembleOutputs", "MostCommonInputs", "MostCommonOutputs",
    "JudgeSynthesisInputs", "JudgeSynthesisOutputs", "VerifierInputs", "VerifierOutputs",
    "SequentialInputs", "SequentialOutputs", "ModelService", "UsageService",
    "EnsembleOperator", "MostCommonAnswerSelectorOperator", "JudgeSynthesisOperator", "VerifierOperator",
    "EnsembleOperatorInputs", "MostCommonAnswerSelectorOperatorInputs", "VerifierOperatorInputs",
    "XCSStub", "DeviceMesh", "PartitionSpec", "LMModule", "LMModuleConfig", "OperatorProtocol"
]