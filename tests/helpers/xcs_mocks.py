...
from typing import Any, Callable, Dict, List, Optional, TypeVar, Union, Protocol, runtime_checkable
...
class MockXCSGraph:
        ...
        with self._lock:
            ...
            # Original interface
                ...
                if name is None or func is None:
                    raise ValueError("Must provide name and func when not using operator/node_id")
    ...
    def execute(self, output_nodes: Optional[List[str]] = None) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            return {node_id: self._results[node_id] for node_id in output_nodes 
...
def execute_graph(graph: MockXCSGraph, global_input: Dict[str, Any] = None, concurrency: bool = False, **options) -> Dict[str, Any]:
