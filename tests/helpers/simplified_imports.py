...
try:
    ...
    from ember.core.registry.operator.core.ensemble import UniformEnsemble, EnsembleOperatorInputs as EnsembleInputs
    from ember.core.registry.operator.core.most_common import MostCommon
    from ember.core.registry.operator.core.synthesis_judge import JudgeSynthesis, JudgeSynthesisInputs
    ...
    class Operator(Generic[T_in, T_out]):
        ...
        def __call__(self, *, inputs: Dict[str, Any] = None, **kwargs) -> Dict[str, Any]:
