"""Integration tests for Avior components."""
...
class TestIntegration(unittest.TestCase):
    ...
    @patch("avior.registry.operator_registry.LMOperatorUnit.forward")
    ...
    @patch("avior.registry.operator_registry.MostCommonOperator.forward")
    ...
    @patch("avior.registry.operator_registry.EnsembleOperator.forward")
    @patch("avior.registry.operator_registry.MostCommonOperator.forward")
    ...
    #     from avior.registry.operator_registry import EnsembleOperator, MostCommonOperator, OperatorFactory
