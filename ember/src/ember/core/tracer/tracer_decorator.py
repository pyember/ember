...
from src.ember.core.scheduler import Scheduler
from src.ember.core.tracer import convert_traced_graph_to_plan
...
def jit(sample_input: Optional[Dict[str, Any]] = None) -> Callable[[Type[T]], Type[T]]:
    ...
    def decorator(cls: Type[T]) -> Type[T]:
        ...
        def trace_and_compile(self: T, sample_in: Any) -> None:
            ...
            try:
                from src.ember.core.tracer.trace_context import (
                ...
                from src.ember.core.tracer import (
                    TracerContext,
