...
Usage:
    Quick start setup:
        ...
        export ember_CONFIG=MY_WATSONX_CONFIG_FILE
        export ember_CUSTOM_MODEL=MY_WATSONX_EXPERIMENT_MODEL
...
export ember_CONFIG=config.ini.watsonx
export ember_CUSTOM_MODEL=ibm/granite-13b-chat-v2
...
from ember.core.configs.config import get_config
