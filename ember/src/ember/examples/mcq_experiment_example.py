...
Launch this experiment via:
    ...
    python -m src.ember.examples.mcq_experiment_example --config_name "abstract_algebra" --num_samples 5 --max_workers 4
"""
...
from ember.src.ember.core.graph_ir.operator_graph import OperatorGraph
from ember.src.ember.core.graph_ir.operator_graph_runner import OperatorGraphRunner
from src.ember.registry.model.registry.model_registry import GLOBAL_MODEL_REGISTRY
...
from src.ember.registry.dataset.base.loaders import HuggingFaceDatasetLoader
...
from src.ember.core.scheduler import ExecutionPlan
...
from src.ember.modules.lm_modules import LMModuleConfig
